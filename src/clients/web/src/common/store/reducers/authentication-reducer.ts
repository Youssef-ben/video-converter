...
export const setAuthenticationActions = (state: AuthenticationState, dispatch: React.Dispatch<AuthActions>, storage: VytcAsyncStorageProvider): AuthenticationState => {
